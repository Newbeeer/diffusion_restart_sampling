...
class PNDMScheduler(SchedulerMixin, ConfigMixin):
    ...
    def add_noise_between_t(
        ...
        print("add sigma:", torch.sqrt(1-alpha_prod_2 - (alpha_prod_2 / alpha_prod_1) * (1-alpha_prod_1)))
        noisy_samples = torch.sqrt(alpha_prod_2 / alpha_prod_1) * original_samples \
                        + torch.sqrt(1-alpha_prod_2 - (alpha_prod_2 / alpha_prod_1) * (1-alpha_prod_1)) * noise
        return noisy_samples
